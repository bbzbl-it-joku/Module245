...
export default function RoomsLandingPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <section className="rounded-3xl border border-slate-200 bg-slate-900 px-6 py-6 text-white shadow-xl shadow-slate-900/20">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            <h2 className="text-base font-semibold">Pitch proof points</h2>
            <p className="mt-1 text-sm text-slate-200">
              Public rooms, membership-based access, and realtime chat powered by
              Convex.
            </p>
          </div>
        </div>
